...
public class Base64
{
    ...
    { (byte) '-', (byte) '0', (byte) '1', (byte) '2', (byte) '3', (byte) '4',
            ...
            (byte) 'P', (byte) 'Q', (byte) 'R', (byte) 'S', (byte) 'T',
            (byte) 'U', (byte) 'V', (byte) 'W', (byte) 'X', (byte) 'Y',
            (byte) 'Z', (byte) '_', (byte) 'a', (byte) 'b', (byte) 'c',
    ...
    private static void checkParam(byte[] source, int off, int len, int options)
    {
        if (source == null)
        {
    ...
    public static byte[] encodeBytesToBytes(byte[] source, int off, int len,
            int options) throws java.io.IOException
    {
        checkParam(source, off, len, options);
        ...
        {
            return convertSome(source, off, len, options);

        } // end else: don't compress

    } // end encodeBytesToBytes

    private static byte[] convertSome(byte[] source, int off, int len,
            int options)
    {
    ...
    public static byte[] decode(byte[] source, int off, int len, int options)
            throws java.io.IOException
    {
        checkParamDecode(source, off, len, options);
    ...
    private static void checkParamDecode(byte[] source, int off, int len,
            int options)
    {
        // Lots of error checking and exception throwing
        if (source == null)
    ...
    public static class InputStream extends java.io.FilterInputStream
    {
        ...
        private int readB3() throws IOException
        {
            byte[] b3 = new byte[3];
        ...
        private int readB4() throws IOException
        {
            byte[] b4 = new byte[4];
            int i = 0;
            for (i = 0; i < 4; i++)
